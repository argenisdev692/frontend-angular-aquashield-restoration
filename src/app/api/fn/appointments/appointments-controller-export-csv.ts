...
export interface AppointmentsControllerExport$Csv$Params {
  format?: 'csv' | 'xlsx' | 'pdf';
...
export function appointmentsControllerExport$Csv(http: HttpClient, rootUrl: string, params?: AppointmentsControllerExport$Csv$Params, context?: HttpContext): Observable<StrictHttpResponse<any>> {
  const rb = new RequestBuilder(rootUrl, appointmentsControllerExport$Csv.PATH, 'get');
  if (params) {
...
appointmentsControllerExport$Csv.PATH = '/api/v1/appointments/export';
